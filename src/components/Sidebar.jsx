...
function Sidebar() {
    return (
        <>
            <div className="text-white sm:block hidden sm:w-44 md:w-56 w-16 sm:p-3 p-2 border-slate-600 border-r xl:space-y-56 space-y-28 h-[90vh]">
                <div className="space-y-4 sm:pt-4 pt-1">
                    ...
                    <div className="flex items-center justify-center sm:justify-start gap-2 rounded hover:bg-[#FD7014] cursor-pointer py-1 px-2 border border-slate-600">
                        <BiLike size={25} />
