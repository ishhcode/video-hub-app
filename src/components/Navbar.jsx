        ...
        <>
            <nav className="w-full h-[10vh] bg-[#393E46] flex justify-between items-center p-4 sm:gap-5 gap-2 border-b-2 border-gray-500 sticky top-0 z-50">
                ...
                <div className="space-x-2 sm:block hidden">
                    <Button className="bg-[#14181d] border-none rounded-lg hover:bg-[#FD7014] hover:text-white border-slate-900 sm:px-4 sm:py-2 p-2">
                        Login
                    </Button>
                    <Button className="bg-[#EEEEEE] text-stone-950 font-semibold border-none rounded-lg hover:bg-[#FD7014] hover:text-black border-slate-500 sm:px-4 sm:py-2 ">
                        Sign up
                    </Button>
                </div>
